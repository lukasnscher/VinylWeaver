...
const contractABI = require("../artifacts/contracts/Vinylweaver.sol/Vinylweaver.json").abi;

program
    .name("vinylweaver-cli")
    .description("CLI tool for Vinylweaver smart contract")
    .version("1.0.0");
